<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ucAcoes.ascx.cs" Inherits="ucAcoes" %>
...
<h3><asp:Label ID="lblTitle" runat="server"></asp:Label></h3>
    ...
    <asp:GridView ID="GridView1" OnSorting="GridView1_Sorting" DataKeyNames="t08_cd_acao" Width="100%"
    ...
    runat="server" CellPadding="4" ForeColor="#333333" AutoGenerateColumns="False" AllowSorting="True" EnableModelValidation="True">
...
<ItemStyle HorizontalAlign="Center" Width="50px"></ItemStyle>
        ...
        <asp:TemplateField HeaderText="Ação" SortExpression="ds_acao"
        HeaderStyle-HorizontalAlign="Left"
        ItemStyle-HorizontalAlign="Left" ItemStyle-Width="300px">
        <ItemTemplate><%#Eval("ds_acao") %></ItemTemplate>
...
<ItemStyle HorizontalAlign="Left" Width="700px"></ItemStyle>
		 ...
		 <asp:TemplateField HeaderText="Área" SortExpression="nm_acao"
        HeaderStyle-HorizontalAlign="Left"
        ItemStyle-HorizontalAlign="Left" ItemStyle-Width="300px">
        <ItemTemplate><%#Eval("nm_acao") %></ItemTemplate>
...
<ItemStyle HorizontalAlign="Left" Width="300px"></ItemStyle>
		...
		<asp:TemplateField HeaderText="Responsável" SortExpression="ds_parceiro"
        HeaderStyle-HorizontalAlign="Left"
        ItemStyle-HorizontalAlign="Left" ItemStyle-Width="300px">
        <ItemTemplate><%#Eval("ds_parceiro") %></ItemTemplate>
...
<ItemStyle HorizontalAlign="Left" Width="300px"></ItemStyle>
        ...
        ItemStyle-HorizontalAlign="Center" ItemStyle-Width="56px">
...
<ItemStyle HorizontalAlign="Center" Width="56px"></ItemStyle>
          ...
          <asp:TemplateField HeaderText="Andamento" SortExpression="ds_andamento"
        HeaderStyle-HorizontalAlign="Left"
        ItemStyle-HorizontalAlign="Left" ItemStyle-Width="300px">
        <ItemTemplate><%#Eval("ds_andamento") %></ItemTemplate>
...
<ItemStyle HorizontalAlign="Left" Width="500px"></ItemStyle>
		...
		<asp:TemplateField HeaderText="Público Alvo" SortExpression="ds_palvo"
        HeaderStyle-HorizontalAlign="Left"
        ItemStyle-HorizontalAlign="Left" ItemStyle-Width="300px">
        <ItemTemplate><%#Eval("ds_palvo") %></ItemTemplate>
...
<ItemStyle HorizontalAlign="Left" Width="700px"></ItemStyle>
		...
		<asp:TemplateField HeaderText="Local de Atuação" SortExpression="ds_latuacao"
        HeaderStyle-HorizontalAlign="Left"
        ItemStyle-HorizontalAlign="Left" ItemStyle-Width="300px">
        <ItemTemplate><%#Eval("ds_latuacao") %></ItemTemplate>
...
<ItemStyle HorizontalAlign="Left" Width="300px"></ItemStyle>
		 ...
		 <asp:TemplateField HeaderText="Ano" SortExpression="ds_ano"
        HeaderStyle-HorizontalAlign="Left"
        ItemStyle-HorizontalAlign="Left" ItemStyle-Width="300px">
        <ItemTemplate><%#Eval("ds_ano") %></ItemTemplate>
...
<ItemStyle HorizontalAlign="Left" Width="150px"></ItemStyle>
        ...
        <ItemTemplate>
        Início: <%#String.Format("{0:dd/MM/yyyy}", Eval("dt_inicio"))%><br />
        Término: <%#String.Format("{0:dd/MM/yyyy}", Eval("dt_fim"))%><br />
        </ItemTemplate>
    ...
    <fieldset>
       <legend><asp:Label ID="lblHeader" runat="server"></asp:Label></legend>
        ...
        <tr>
            ...
            <td><asp:TextBox  ID="txtnm_acao" Width="350px" MaxLength="200" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator id="RequiredFieldValidator6" 
                    ControlToValidate="txtnm_acao" ErrorMessage="*campo obrigatório" runat="server" 
                    Display="Dynamic"/></td>
        </tr>
        <tr>
        ...
        <tr>
			...
			<td><asp:TextBox ID="txtds_palvo" Width="350px" runat="server" TextMode="MultiLine" Height="50px"></asp:TextBox></td>
        </tr>
		<tr>
            <td><label>Andamento:</label></td>
            <td><asp:TextBox  ID="txtds_andamento" Width="350px" runat="server"  TextMode="MultiLine"
                    Height="50px"></asp:TextBox></td>
        </tr>
		<tr>
            <td><label>Local de Atuação:</label></td>
            <td><asp:TextBox  ID="txtds_latuacao" Width="350px" runat="server"  TextMode="MultiLine"
                    Height="50px"></asp:TextBox></td>
        </tr>
		<tr>
            <td><label>Orgão Responsável:</label></td>
            <td><asp:TextBox  ID="txtds_parceiro" Width="350px" runat="server"  TextMode="MultiLine"
                    Height="50px"></asp:TextBox></td>
        </tr>
        <tr>
            <td>Ano:</td>
            <td><asp:TextBox  ID="txtds_ano" Width="98px" MaxLength="200" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <rjs:PopCalendar ID="PopCalendar3" runat="server" Buttons="[&lt;][m][y]  [&gt;]" Control="txtdt_inicio" ControlFocusOnError="True" Culture="pt-BR" Fade="0.5" Format="dd mm yyyy" From-Message="" IncrementY="-220" InvalidDateMessage="Día Inválido" Move="True" RequiredDate="False" RequiredDateMessage="Selecione Data Início" Separator="/" Shadow="True" ShowWeekend="True" Style="z-index: 102" To-Control="txtTo" />
        ...
        <tr>
            <td><label>Data de Fim:</label></td>
            <td><asp:TextBox ID="txtdt_fim" Width="100px"  runat="server" ReadOnly="true" Text=''></asp:TextBox>
            <rjs:PopCalendar ID="PopCalendar4" runat="server"
            Buttons="[<][m][y]  [>]" Control="txtdt_fim"
            ...
            <asp:RequiredFieldValidator id="RequiredFieldValidator2" 
                    ControlToValidate="txtdt_fim" ErrorMessage="*campo obrigatório" runat="server" 
                    Display="Dynamic"/>
        ...
        <tr>
            <td><label>Data de Aviso:</label></td>
            <td><asp:TextBox ID="txtdt_aviso" Width="100px"  runat="server" ReadOnly="true" Text=''></asp:TextBox>
            <rjs:PopCalendar ID="PopCalendar5" runat="server"
            Buttons="[<][m][y]  [>]" Control="txtdt_aviso"
            ControlFocusOnError="True" Culture="pt-BR" Fade="0.5" IncrementY="-220" 
            Format="dd mm yyyy" From-Message="" InvalidDateMessage="Día Inválido"
            Move="True" RequiredDate="False" RequiredDateMessage="Selecione Data Aviso" Separator="/"
            Shadow="True" ShowWeekend="True" Style="z-index: 102" To-Control="txtTo" /> 
            <asp:RequiredFieldValidator id="RequiredFieldValidator3" 
                    ControlToValidate="txtdt_aviso" ErrorMessage="*campo obrigatório" 
