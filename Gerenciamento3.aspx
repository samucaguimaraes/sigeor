<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Gerenciamento3.aspx.cs" Inherits="Gerenciamento3" Title="Agenda Bahia" %>
<%@ Register Src="~/ucNavegacao.ascx" TagName="Nav" TagPrefix="uc" %>
<%@ Register Src="~/ucLegenda.ascx" TagName="Legenda" TagPrefix="uc" %>
<%@ Register Src="~/ucAcoes2014.ascx" TagName="Acao" TagPrefix="uc" %>
