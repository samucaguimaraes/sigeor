...
public class t03_projeto
{
	...
	public DataSet List()
	{
		...
		SqlDataAdapter adp = new SqlDataAdapter("select * from t03_projeto " + _order, sqlConn);
    ...
    public DataSet ListQuery()
    {
        SqlConnection sqlConn = new SqlConnection(pb.strConn());
        SqlDataAdapter adp = new SqlDataAdapter(_order, sqlConn);
        DataSet ds = new DataSet();
    ...
    public DataSet ListEntidade()
    {
        SqlConnection sqlConn = new SqlConnection(pb.strConn());
        SqlDataAdapter adp = new SqlDataAdapter("select * from t01_entidade where fl_ativa=1 " + _order, sqlConn);
        DataSet ds = new DataSet();
    ...
    public DataSet ListEntidadeAdm()
    {
        SqlConnection sqlConn = new SqlConnection(pb.strConn());
        SqlDataAdapter adp = new SqlDataAdapter("select * from t01_entidade where t01_cd_entidade=@t01_cd_entidade order by nm_entidade", sqlConn);
    ...
    public DataSet ListTipologia()
    {
        SqlConnection sqlConn = new SqlConnection(pb.strConn());
        SqlDataAdapter adp = new SqlDataAdapter("select * from t04_tipologia where fl_ativa=1 and t04_cd_tipologia in (select t04_cd_tipologia from t03_projeto where "+ _order +" fl_ativa=1 and t01_cd_entidade=@t01_cd_entidade) order by nm_tipologia", sqlConn);
        adp.SelectCommand.Parameters.Add("@t01_cd_entidade", SqlDbType.Int).Value = _t01_cd_entidade;
        DataSet ds = new DataSet();
	...
	{
		SqlConnection sqlConn = new SqlConnection(pb.strConn());
        SqlCommand cmd = new SqlCommand("select * from t03_projeto where t03_cd_projeto=@t03_cd_projeto", sqlConn);
    ...
    {
        SqlConnection sqlConn = new SqlConnection(pb.strConn());
        SqlCommand cmd = new SqlCommand("select * from t03_projeto where nm_projeto=@nm_projeto and t01_cd_entidade=@t01_cd_entidade order by dt_cadastro desc", sqlConn);
	...
	{
		SqlConnection sqlConn = new SqlConnection(pb.strConn());
        SqlCommand cmd = new SqlCommand("insert into t03_projeto (t02_cd_usuario, t02_cd_usuario_monitoramento,t04_cd_tipologia, t01_cd_entidade, nm_projeto, dt_inicio, dt_fim, dt_cadastro, fl_ativa) " +
                                                     "values(@t02_cd_usuario,@t02_cd_usuario_monitoramento, @t04_cd_tipologia, @t01_cd_entidade, @nm_projeto, '', '2099-12-31', @dt_cadastro, @fl_ativa)", sqlConn);
		bool result;
    ...
    {
        SqlConnection sqlConn = new SqlConnection(pb.strConn());
        SqlCommand cmd = new SqlCommand("update t03_projeto set t02_cd_usuario=@t02_cd_usuario, t02_cd_usuario_monitoramento=@t02_cd_usuario_monitoramento, t04_cd_tipologia=@t04_cd_tipologia,  nm_projeto=@nm_projeto where t03_cd_projeto=@t03_cd_projeto", sqlConn);
        bool result;
    ...
    public bool UpdateArvore()
    {
        SqlConnection sqlConn = new SqlConnection(pb.strConn());
        SqlCommand cmd = new SqlCommand("update t03_projeto set dt_alterado=@dt_alterado " + _order + " where t03_cd_projeto=@t03_cd_projeto", sqlConn);
        bool result;
	...
	{
		SqlConnection sqlConn = new SqlConnection(pb.strConn());
        SqlCommand cmd = new SqlCommand("update t03_projeto set fl_ativa=0, dt_alterado=getdate()  where t03_cd_projeto=@t03_cd_projeto", sqlConn);
        cmd.Parameters.Add("@t03_cd_projeto", SqlDbType.Int).Value = _t03_cd_projeto;
		bool result;
