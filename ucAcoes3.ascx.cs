...
public partial class ucAcoes3 : System.Web.UI.UserControl
{
    ...
    protected void Pesquisa(object sender, EventArgs e)
    {
        ...
        ViewState["pesquisa"] = " and (ds_ano like '%" + find + "%')";
        order = ViewState["pesquisa"].ToString() + " order by ds_acao";
        GridBind2(order);
