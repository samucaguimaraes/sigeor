    ...
    protected void GridBind(string fl_status)
    {
        try
        {
            t03_projeto t03 = new t03_projeto();
            {
                ...
                sb.Append("<td colspan=\"13\">Projetos</td>");
                sb.Append("</tr>");
                ...
                foreach (DataRow dr in t03.ListQuery().Tables[0].Rows)
                {
                    ...
                    sb.Append("<td colspan=\"13\">" + dr["nm_projeto"] + "</td>");
                    sb.Append("</tr>");
						...
						if (dtatual >= dtaviso)
						{
							if (imagem != "B")
							{
								...
								if (index == 0)
                                    ...
                                    sb.Append("<td width='25%'>Programa</td>");
									sb.Append("<td width='10%'>Setor</td>");
									...
									n = n+1;
									sb.Append("<td>" + n + "</td>");
                                    sb.Append("<td>" + dra["cd_programa"] + "</td>");
									sb.Append("<td>" + dra["ds_setor"] + "</td>");
