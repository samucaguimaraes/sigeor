<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="frmTipologia.aspx.cs" Inherits="frmTipologia" Title="Agenda Bahia" %>
    ...
    <fieldset>
        ...
        <asp:Panel ID="PanelAdd" runat="server">
            ...
            <br />
                ...
                <asp:TextBox ID="txtnm_tipologia" Width="250px" MaxLength="500" runat="server"></asp:TextBox>
                <asp:Button ID="btnAdd" runat="server" Text="Adicionar" 
                            onclick="btnAdd_Click" />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtnm_tipologia"
                 runat="server" ErrorMessage="*campo obrigatório" Display="Dynamic"></asp:RequiredFieldValidator>
            <hr class="dashed" />

            
        </asp:Panel>
        <asp:GridView ID="GridView1" DataKeyNames="t04_cd_tipologia" Width="100%" GridLines="Both"
            ...
            <asp:TemplateField HeaderStyle-Width="20px">
            <ItemTemplate>
             <asp:ImageButton ID="ImageButton2" CausesValidation="false" CommandArgument='<%#Eval("t04_cd_tipologia")%>' 
            ...
            <asp:TemplateField HeaderText="Tipologia" SortExpression="nm_tipologia">
            <ItemTemplate>
            <%#Eval("nm_tipologia")%></ItemTemplate>
            <EditItemTemplate>
              ...
              <asp:TextBox ID="txtnm_tipologia" Width="250px" MaxLength="500" Text='<%#Eval("nm_tipologia")%>' runat="server"></asp:TextBox>
              <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtnm_tipologia"
