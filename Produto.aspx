<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Produto.aspx.cs" Inherits="Produto" Title="Agenda Bahia" %>
...
<uc:Projeto runat="server" ID="ucProjeto" />
         <div class="heading_container"><div class="heading_right_top"></div>
            <h2 id="H2">Detalhamento do Produto</h2></div>
        ...
        <tr>
            <td><label style="font-weight:bold">Descrição:</label> 
                <asp:Label ID="lblds_produto" runat="server"></asp:Label>
             </td>
        </tr>
        <tr>
            <td><label style="font-weight:bold">Unidade de Medida:</label> 
                <asp:Label ID="lblnm_medida" runat="server"></asp:Label>
             </td>
        </tr>
        <tr>
