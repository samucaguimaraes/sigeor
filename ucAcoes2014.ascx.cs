...
public partial class ucAcoes : System.Web.UI.UserControl
{
    ...
    private void GridBind()
    {
        t08_acao t08 = new t08_acao();
        {
            ...
            t08.order = "and ds_ano like '2015' order by " + ViewState["campo"].ToString() +" "+ ViewState["sentido"].ToString();
 ...
 //   }
    ...
    protected void btnAcao_Click(object sender, System.EventArgs e)
    {
        ...
        t08_acao t08 = new t08_acao();
        {
            ...
            t08.ds_setor = pb.ReplaceAspas(txtds_setor.Text);
            t08.cd_programa = pb.ReplaceAspas(txtcd_programa.Text);

            t08.nu_acao = pb.ReplaceAspas(txtnu_acao.Text);
            t08.ds_compromisso = pb.ReplaceAspas(txtds_compromisso.Text);
            t08.ds_subacao = pb.ReplaceAspas(txtds_subacao.Text);
