<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="frmUsuario.aspx.cs" Inherits="frmUsuario" Title="Agenda Bahia" %>
...
<h3><img alt="" src="images/arrow_right.gif" /> <asp:Label ID="lblTitle" runat="server"></asp:Label></h3>
    ...
    runat="server" CellPadding="4" ForeColor="#333333" AutoGenerateColumns="False" AllowSorting="True">
        ...
        <ItemTemplate>
            <asp:ImageButton ID="ImageButton2" CommandArgument='<%#Eval("t02_cd_usuario")%>' 
            ImageUrl="~/images/ico_key.gif" CausesValidation="false" runat="server" OnClick="Senha_Click" AlternateText="Alterar Senha"/>
        </ItemTemplate>
